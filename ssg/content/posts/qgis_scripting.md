...
# Working with PyQGIS
The PyQGIS docs are located here TODO: link docs, and they're solidly ok.  But, still, I'd suggest doing as many type hints as possible so the IDE will fill in suggestions.  And you'll have to set most of the type hints manually, the way the files are set up doesn't always make the return types obvious to humans or the IDE.
